...
interface MessageListProps {
  ...
  contextMenuMessageId?: number; // New prop for context menu highlight
...
const MessageList = forwardRef<HTMLDivElement, MessageListProps>((props, ref) => {
  const {
    ...
    contextMenuMessageId, // Destructure new prop
  ...
  return (
    <>
      {/* Inline styles for the context menu highlight */}
      <style>
        {`
          ...
          return (
            <React.Fragment key={message.id}>
              ...
              <div
                ...
                } ${contextMenuMessageId === message.id ? 'context-menu-highlight' : ''}`} // Add context menu highlight
